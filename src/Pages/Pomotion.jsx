...
function Pomotion() {
  return (
    <>
      <section class="bg-dark1 px-4 py-8 antialiased dark:bg-gray-900 md:py-16">
        <div class="mx-auto grid max-w-screen-xl rounded-lg bg-dark3 p-4 dark:bg-gray-800 md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-16 xl:gap-16">
