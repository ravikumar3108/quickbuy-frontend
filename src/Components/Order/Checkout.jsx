...
import { AuthContext } from "../../Auth/AuthUser";
...
function Checkout() {
  ...
  return (
    <>
      <Layout>
        <section class="py-4 antialiased dark:bg-gray-900 md:py-10">
          <div class="mx-auto max-w-screen-xl py-4 2xl:px-0 bg-dark3">
            <div class="mx-auto max-w-5xl">
              <h2 class="text-xl font-semibold text-gray-200 dark:text-white sm:text-2xl">
                Payment
              </h2>
              ...
              <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
                ...
                >
                  ...
                  <button
                    ...
                    type="submit"
                    class="flex w-full items-center justify-center rounded-lg bg-main px-5 py-2.5 text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4  focus:ring-red-300 dark:bg-primary-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                  >
                    Pay now
                  </button>
                </form>
