...
function Confirmation() {
  return (
    <>
      <section className="py-8 antialiased dark:bg-gray-200 md:py-16">
        <div className="mx-auto max-w-2xl px-4 2xl:px-0">
          <h2 className="text-xl font-semibold text-white dark:text-white sm:text-2xl mb-2">
            Thanks for your order!
          </h2>
          <p className="text-white dark:text-gray-400 mb-6 md:mb-8">
            Your order{" "}
            <Link
              to="#"
